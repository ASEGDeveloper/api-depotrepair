    ...
    <tr>
        <td align="center" style="padding:16px 10px;">
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="620" style="background-color:#ffffff; border:1px solid #dddddd;">
                ...
                <!-- Header -->
                <tr>
                    <td bgcolor="#1a8a5a" style="background-color:#1a8a5a; padding:12px 20px;">
                        <p style="margin:0; font-family:Arial,Helvetica,sans-serif; font-size:18px; font-weight:bold; color:#ffffff;">Gate Pass Approved by Manager</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:16px 20px;">
                        ...
                        <p style="margin:0 0 12px 0; font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#333333;">
                            The following gate pass has been <strong style="color:#1a8a5a;">approved</strong> by the manager.
                        </p>
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border:1px solid #dddddd; margin-bottom:12px;">
                            ...
                            <tr>
                                ...
                                <td style="padding:5px 12px; font-family:Arial,Helvetica,sans-serif; font-size:13px; color:#1a8a5a; font-weight:bold;">{{ $comment ?? 'approved' }}</td>
                            </tr>
                        </table>
